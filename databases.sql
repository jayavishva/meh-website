...
(name, description, price, stock, category, quantity_value, quantity_unit, image_url, image_path, status)
VALUES
(
  'Natural Henna Powder',
  'Pure natural henna powder for beautiful designs',
  299.00,
  50,
  'Henna Powder',
  100,
  'g',
  NULL,
  'assets/images/eucalyptus_oil.jpg',
  'active'
),
(
  'Mehendi Cone Set',
  'Professional mehendi cone set with 5 cones',
  199.00,
  30,
  'Cones',
  5,
...
(
  'Henna Oil',
  'Essential oil for darker and longer-lasting mehendi',
  149.00,
  40,
  'Accessories',
  10,
  'ml',
  NULL,
 'assets/images/levendor_oil.jpg',
  'active'
),
(
  'Design Stencils',
  'Reusable mehendi design stencils pack of 10',
  249.00,
  25,
  'Accessories',
  10,
...
(
  ...
  'Premium quality henna powder with natural ingredients',
  399.00,
  35,
  'Henna Powder',
  250,
